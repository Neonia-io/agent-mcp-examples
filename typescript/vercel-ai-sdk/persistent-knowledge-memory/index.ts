...
async function main() {
    ...
    const transport = new StreamableHTTPClientTransport(new URL("https://mcp.neonia.io/mcp?tools=neonia_sys_memory_lesson,neonia_sys_memory_search"), {
    ...
    const tools = {
        neonia_sys_memory_lesson: aiTool({
            ...
            execute: async (args) => {
                console.log(`[Memory Tool] Agent executed: neonia_sys_memory_lesson`);
                try {
                    const result = await client.callTool({
                        name: "neonia_sys_memory_lesson",
        ...
        neonia_sys_memory_search: aiTool({
            ...
            execute: async (args) => {
                console.log(`[Memory Tool] Agent executed: neonia_sys_memory_search (query='${args.query}')`);
                try {
                    const result = await client.callTool({
