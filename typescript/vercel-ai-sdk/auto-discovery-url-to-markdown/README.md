# Auto-Pilot Tool Discovery Example (TypeScript)

This example demonstrates how to build a fully autonomous agent using the **Vercel AI SDK** that dynamically discovers and executes missing capabilities on the fly via the Neonia MCP Gateway.
